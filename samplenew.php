...
<div class="shadow">
	...
	<a href="#">Adventure Tours</a><br><br>
	<a href="#">Family Package </a><br><br>
	<a href="#">Golden Triangle</a><br><br>
	<a href="#">Chota break</a><br><br>
	<a href="#">Beach Holidays</a><br><br>
	<a href="#">Adventure Tours</a><br><br>
</font>
</div>
</div>
...
<?php 
        ...
        $query = "SELECT package_id,s_id,pac_name,cat_name,days,night,cost,image FROM tbl_create_package";  
             ...
             echo '<img src="data:image/jpeg;base64,'.base64_encode($row['imgname']).'" width="33.7%" height="33.7%"/>';
echo '
  <h3>'.($row['pac_name']).'</h3><br>
  <h5>'.$package.'</h5><br>
    Days:'.($row['days']).'<br>';
    
    echo "   <a href=view_details.php?id=$row[package_id]><p><button>View Details</button></p></a><a href=><button class=button2>Enquiry now</button></a>
</div></div></body>
</html>";
