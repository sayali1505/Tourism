...
$id=$_SESSION['package_id'];
		...
		$queryn="select * from pac_cost where p_id='$id'";
		$resultn=mysqli_query($db,$queryn);
                ...
                { 
                    ...
                    while($row=$result->fetch_array())  
                    {
                        ...
                        $night=$row['night'];
                        $cost=$row['cost'];
                     while ($row2=$resultn->fetch_array()) {
                        	$cost=$row2['Other'];
                        	$ac=$row2['AC'];
                        	$tot=$cost+$ac;
                        }   
...
<img src="<?= $row['image'] ?>" style="width: 30%; height: 40%; margin-top: 5%;margin-left: 3%;">

<div class="three"><div class="btn" style="background-color: #ffd633;"><font size="5"> <?= $tot; ?>
...
<div class="input_fields_wrap">
 ...
 <button class="add_field_button">Add Room</button></div>
	...
	<font size="6" color="darkblue"><?= $row['pac_name']; ?></font>

	<font size="4"><b>Days :<?= $row['days'] ?></b>&nbsp&nbsp<b>Nights : <?= $row['night'] ?></b></font>
	<!--
...
$count=0;
echo "<form action=newbook1.php method=POST>";
...
echo '<div class=fontsize><b>Destinations:</b>'.$package .'<br><br></div>
