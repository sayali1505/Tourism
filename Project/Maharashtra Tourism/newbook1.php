...
<div class="two">
	<font size="5" color="darkblue">Package Name : <?= $row['pac_name']; ?><br>  Category : <?= $name ?> </font><font color="green" size="5"> Grand Total : </font><font size="5" color="red"><?= $total ?></font><br><br>
...
--><br>
Total Adults : <?=$adult ?> Total children : <?=$child ?><br>
Date of booking :<input type="text" name="bdate" placeholder="yyyy/dd/mm"><br>
<input type="hidden" name="adult" value="<?= $adult ?>">
<input type="hidden" name="child" value="<?= $child ?>">
<input type="hidden" name="total" value="<?= $total ?>">
