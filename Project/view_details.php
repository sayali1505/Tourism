...
<?php 
        ...
        $query = "SELECT s_id,pac_name,cat_name,days,night,cost,image FROM tbl_create_package where package_id=$id";  
          ...
          while ($r1=$res1->fetch_array()) {
            ...
            <a href=mah_signin.php><input type=submit id=book name="submit" placeholder="Book Now" value="Book Now"></a></p>
            ...
            <div class=itenarary>Iternary:<br><br>'.$name1.'</div>
            <div class=itenarary>'.$name2.'</div>
            </div>
