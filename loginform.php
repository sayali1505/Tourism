...
if($checkrows>0)
{
  echo "<div class=ck>Already exists in table<br><br><a href=loginform.html><button float=right>Back</button></a></div>";
}
else
{
  ...
  echo "<div class=ck>New record created successfully.<br><br><a href=loginform.html><button float=right>Back</button></a></div>";
  }
  else{
