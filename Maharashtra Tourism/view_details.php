...
<?php 
        ...
        $query = "SELECT package_id,s_id,pac_name,cat_name,days,night,cost,image FROM tbl_create_package where package_id=$id";  
          ...
          while ($r=$res->fetch_array()) 
          {
            ...
            <a href=mah_login.php?id='.$row['package_id'].'><input type=hidden name=id value='.($row['package_id']).'><input type=submit id=book name="submit" placeholder="Book Now" value="Book Now"></a></p>
