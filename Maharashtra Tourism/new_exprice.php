...
$pdf->SetX(20);
$pdf->Cell(0,15,'Price wise report',0,1,'C',false);
$pdf->SetFont('Times','B',14);
$pdf->SetX(20);
$pdf->SetY(60);
$pdf->Cell(0,5, 'Price : '.$srange.' to '.$erange,0,1,'L',false);
$pdf->SetY(50);
...
$result=mysqli_query($conn,"select package_id,pac_name,cat_name,days,night,cost from tbl_create_package  where cost between '$srange' ANd '$erange' order by package_id");
